test_that("K Function - Check existant K", {
  ...
  # Check K
  expect_equal(c(0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,
                 ...
                 3058.739663, 3199.854683), KFunction$K1)
})


test_that("K Function - Check non-existant K", {
  KFunction <- getKFunction(agents=c('B','FAKE'), unit='Person',
                            data=TNBC_pheno[TNBC_pheno$Person==1,-1],
                            rCheckVals=seq(0,50,1),
                            edgeCorrection="isotropic")
