...
saveRDS(list('data'=pcaMeta,'dat'=dat),'C:/Users/jerem/Downloads/allVal_extreme.rds')
rfcv <- funkyModel(
...
saveRDS(list('data'=pcaMeta,'dat'=dat),'C:/Users/jerem/Downloads/noval_extreme.rds')
rfcv <- funkyModel(
  data = pcaMeta, outcome = "Stage", unit = "Person",
  metaNames = c("corrNorm"),
  subsetPlotSize = 25)
