...
This vignette examines lung cancer data.
```{r load_data}
dat <- lungcancer
```
...
set.seed(12345)
model_fm <- funkyModel(data = data_rf[!is.na(data_rf[['Cancer']]),],
