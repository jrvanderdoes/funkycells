...
png("./paper/tnbc_person2_tumour_mononeu_k.png", width = 800, height = 800)
# png("./vignettes/paper/tnbc_person2_tumour_mononeu_k.png", width = 800, height = 800)
print(k_fig)
dev.off()
```
