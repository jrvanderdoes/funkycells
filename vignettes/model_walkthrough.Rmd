...
img1 <- plotPP(
  data = cell_data[cell_data$Image == 1, c("x", "y", "cellType")],
  ptSize = 3, dropAxes = T, colorGuide = "none"
)
png("./paper/diagram_pp1.png", width = 800, height = 800)
# png("./vignettes/paper/diagram_pp1.png", width = 800, height = 800)
print(img1)
dev.off()

img21 <- plotPP(
  data = cell_data[cell_data$Image == 21, c("x", "y", "cellType")],
  ptSize = 3, dropAxes = T, colorGuide = "none"
)
png("./paper/diagram_pp21.png", width = 800, height = 800)
# png("./vignettes/paper/diagram_pp21.png", width = 800, height = 800)
print(img21)
dev.off()

img41 <- plotPP(
  data = cell_data[cell_data$Image == 41, c("x", "y", "cellType")],
  ptSize = 3, dropAxes = T, colorGuide = "none"
)
png("./paper/diagram_pp41.png", width = 800, height = 800)
# png("./vignettes/paper/diagram_pp41.png", width = 800, height = 800)
print(img41)
dev.off()
```
...
AA_im1 <- getKFunction(cell_data[cell_data$Image==1,
                             !(colnames(cell_data)%in%('Stage'))],
             agents = c("A","A"),unit = "Person",repeatedUniqueId = "Image",
             rCheckVals = seq(0,0.25,0.01),xRange = c(0,1),yRange = c(0,1))
AB_im1 <- getKFunction(cell_data[cell_data$Image==1,
                             !(colnames(cell_data)%in%('Stage'))],
             agents = c("A","B"),unit = "Person",repeatedUniqueId = "Image",
             rCheckVals = seq(0,0.25,0.01),xRange = c(0,1),yRange = c(0,1))
...
png("./paper/diagram_K_AA_i1.png", width = 800, height = 800)
# png("./vignettes/paper/diagram_K_AA_i1.png", width = 800, height = 800)
print(AAfig_im1)
dev.off()
...
Often data is also collected with some meta-variables, such as with patient age or sex Both age and sex are simulated below. In the simulation, higher age is related to stage $1$ while sex has no effect.
```{r simulate_meta}
set.seed(123)
...
png("./paper/diagram_variableimportance.png")
# png("./vignettes/paper/diagram_variableimportance.png")
print(plot_vi_full)
dev.off()
...
png("./paper/diagram_variableimportance_names.png")
# png("./vignettes/paper/diagram_variableimportance.png")
